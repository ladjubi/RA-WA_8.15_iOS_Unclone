...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0E:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A09:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0H:Ljava/util/List;

    new-instance v1, LX/1qz;

    const/4 v0, 0x0

    invoke-direct {v1, p0, v0}, LX/1qz;-><init>(Lcom/whatsapp/PhoneContactsSelector;LX/1qv;)V

    iput-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0I:LX/1qz;

    invoke-static {}, LX/27g;->A00()LX/1U3;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0O:LX/1U3;

    invoke-static {}, LX/0yQ;->A00()LX/0yQ;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0M:LX/0yQ;

    invoke-static {}, LX/15v;->A00()LX/15v;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A04:LX/15v;

    invoke-static {}, LX/15c;->A00()LX/15c;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A01:LX/15c;

    invoke-static {}, LX/1CZ;->A00()LX/1CZ;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A02:LX/1CZ;

    invoke-static {}, LX/0r8;->A01()LX/0r8;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A05:LX/0r8;

    invoke-static {}, LX/19h;->A00()LX/19h;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0N:LX/19h;

    return-void
.end method

.method public static synthetic A00(Lcom/whatsapp/PhoneContactsSelector;)V
    .locals 3

    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A08:LX/0vy;
    ...
    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A08:LX/0vy;

    :cond_0
    new-instance v2, LX/0vy;

    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A07:Ljava/util/ArrayList;

    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0E:Ljava/util/ArrayList;

    invoke-direct {v2, p0, v1, v0}, LX/0vy;-><init>(Lcom/whatsapp/PhoneContactsSelector;Ljava/util/List;Ljava/util/List;)V

    iput-object v2, p0, Lcom/whatsapp/PhoneContactsSelector;->A08:LX/0vy;

    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0O:LX/1U3;
...
.method public final A0h()V
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0N:LX/19h;
    ...
    :cond_0
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0D:LX/0vz;
    ...
    :cond_1
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A06:Ljava/lang/String;
...
.method public final A0i()V
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0K:Landroid/view/View;
    ...
    iget-boolean v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0L:Z

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0P:Landroid/view/View;
...
.method public final A0k(LX/0vv;)V
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0C:Landroid/widget/ListView;
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0H:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0I:LX/1qz;
    ...
    iget-object v3, p0, Lcom/whatsapp/PhoneContactsSelector;->A0K:Landroid/view/View;

    const/4 v2, 0x4

    invoke-virtual {v3, v2}, Landroid/view/View;->setVisibility(I)V

    invoke-virtual {p0}, Lcom/whatsapp/PhoneContactsSelector;->A0i()V

    iget-boolean v2, p0, Lcom/whatsapp/PhoneContactsSelector;->A0L:Z
    ...
    invoke-direct {v0, p0, v5}, LX/0w1;-><init>(Lcom/whatsapp/PhoneContactsSelector;I)V
    ...
    invoke-virtual {p0, v0}, Lcom/whatsapp/PhoneContactsSelector;->A0j(I)V
    ...
    invoke-direct {v0, p0, p1}, LX/0hK;-><init>(Lcom/whatsapp/PhoneContactsSelector;LX/0vv;)V
    ...
    :cond_4
    iget-object v2, p0, Lcom/whatsapp/PhoneContactsSelector;->A0K:Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/whatsapp/PhoneContactsSelector;->A0P:Landroid/view/View;
    ...
    invoke-direct {v0, p0, v3}, LX/0w1;-><init>(Lcom/whatsapp/PhoneContactsSelector;I)V
    ...
    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0J:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0I:LX/1qz;
...
.method public synthetic lambda$onCreate$1$PhoneContactsSelector(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0M:LX/0yQ;
...
.method public onBackPressed()V
    ...
    iget-boolean v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0A:Z

    if-eqz v0, :cond_1

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0A:Z

    invoke-static {}, LX/1Ts;->A02()V

    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A09:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A09:Ljava/util/ArrayList;

    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0E:Ljava/util/ArrayList;

    invoke-virtual {v1, v0}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A00:LX/0vw;
    ...
    :cond_0
    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0G:LX/0x5;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A04:LX/15v;

    invoke-virtual {v0, p0}, LX/15v;->A08(Landroid/content/Context;)LX/15u;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A03:LX/15u;
    ...
    invoke-direct {v9, p0}, LX/1qv;-><init>(Lcom/whatsapp/PhoneContactsSelector;)V
    ...
    iput-object v4, p0, Lcom/whatsapp/PhoneContactsSelector;->A0G:LX/0x5;
    ...
    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0B:LX/255;

    invoke-virtual {p0}, LX/0P6;->A0f()Landroid/widget/ListView;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0C:Landroid/widget/ListView;

    invoke-virtual {v0, v3}, Landroid/widget/ListView;->setFastScrollAlwaysVisible(Z)V

    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0C:Landroid/widget/ListView;
    ...
    :cond_0
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A08:LX/0vy;
    ...
    invoke-direct {v4, p0}, LX/0vz;-><init>(Lcom/whatsapp/PhoneContactsSelector;)V

    iput-object v4, p0, Lcom/whatsapp/PhoneContactsSelector;->A0D:LX/0vz;
    ...
    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0J:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {v0, p0, v4}, LX/1qw;-><init>(Lcom/whatsapp/PhoneContactsSelector;I)V
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0J:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v5, p0, Lcom/whatsapp/PhoneContactsSelector;->A0J:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {v0, p0}, LX/0vt;-><init>(Lcom/whatsapp/PhoneContactsSelector;)V
    ...
    iget-object v5, p0, Lcom/whatsapp/PhoneContactsSelector;->A0C:Landroid/widget/ListView;
    ...
    invoke-direct {v0, p0}, LX/0hH;-><init>(Lcom/whatsapp/PhoneContactsSelector;)V
    ...
    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0K:Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0K:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0P:Landroid/view/View;
    ...
    iput-boolean v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0L:Z
    ...
    invoke-direct {v3, p0, p0, v1, v0}, LX/0vw;-><init>(Lcom/whatsapp/PhoneContactsSelector;Landroid/content/Context;ILjava/util/List;)V

    iput-object v3, p0, Lcom/whatsapp/PhoneContactsSelector;->A00:LX/0vw;
    ...
    invoke-direct {v0, p0}, LX/1qx;-><init>(Lcom/whatsapp/PhoneContactsSelector;)V
    ...
    invoke-direct {v0, p0}, LX/0hI;-><init>(Lcom/whatsapp/PhoneContactsSelector;)V
    ...
    invoke-direct {v0, p0}, LX/1qy;-><init>(Lcom/whatsapp/PhoneContactsSelector;)V
    ...
    invoke-static {p0, v1, v0, v2}, Lcom/whatsapp/RequestPermissionActivity;->A0A(Landroid/app/Activity;IIZ)V

    :cond_3
    invoke-virtual {p0}, Lcom/whatsapp/PhoneContactsSelector;->A0h()V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    iput-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0F:Landroid/view/MenuItem;

    const/16 v0, 0xa

    invoke-interface {v1, v0}, Landroid/view/MenuItem;->setShowAsAction(I)V

    iget-object v1, p0, Lcom/whatsapp/PhoneContactsSelector;->A0F:Landroid/view/MenuItem;

    new-instance v0, LX/0vu;

    invoke-direct {v0, p0}, LX/0vu;-><init>(Lcom/whatsapp/PhoneContactsSelector;)V
...
.method public onDestroy()V
    ...
    iput-object v2, p0, Lcom/whatsapp/PhoneContactsSelector;->A0D:LX/0vz;
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A03:LX/15u;
...
.method public onSearchRequested()Z
    ...
    iget-object v0, p0, Lcom/whatsapp/PhoneContactsSelector;->A0G:LX/0x5;
