...
.field public A02:Lcom/whatsapp/doodle/ImagePreviewContentLayout;

.field public final A03:LX/2la;

.field public A04:Lcom/whatsapp/gallerypicker/OnZoomListenerPhotoView;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A00:LX/0sL;

    invoke-static {}, LX/0xH;->A03()LX/0xH;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A05:LX/0xH;

    invoke-static {}, LX/2la;->A0M()LX/2la;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A03:LX/2la;

    invoke-static {}, LX/19a;->A00()LX/19a;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A06:LX/19a;

    invoke-static {}, LX/1A7;->A00()LX/1A7;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A07:LX/1A7;
...
.method public A0n()V
    ...
    iget-object v4, p0, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A00:LX/1GT;

    iget-object v2, v4, LX/1GT;->A08:Lcom/whatsapp/doodle/DoodleView;

    iget-object v0, v2, Lcom/whatsapp/doodle/DoodleView;->A07:Landroid/graphics/Bitmap;
    ...
    iput-object v1, v2, Lcom/whatsapp/doodle/DoodleView;->A07:Landroid/graphics/Bitmap;

    :cond_0
    iget-object v0, v2, Lcom/whatsapp/doodle/DoodleView;->A09:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->recycle()V

    iput-object v1, v2, Lcom/whatsapp/doodle/DoodleView;->A09:Landroid/graphics/Bitmap;

    :cond_1
    iget-object v0, v2, Lcom/whatsapp/doodle/DoodleView;->A05:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->recycle()V

    iput-object v1, v2, Lcom/whatsapp/doodle/DoodleView;->A05:Landroid/graphics/Bitmap;
    ...
    :cond_4
    iget-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A05:LX/0xH;
    ...
    iget-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A02:Lcom/whatsapp/doodle/ImagePreviewContentLayout;
    ...
    :cond_5
    iget-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A04:Lcom/whatsapp/gallerypicker/OnZoomListenerPhotoView;
...
.method public A0q(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-super {p0, p1, p2}, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A0q(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A04:Lcom/whatsapp/gallerypicker/OnZoomListenerPhotoView;
    ...
    iget-object v1, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A04:Lcom/whatsapp/gallerypicker/OnZoomListenerPhotoView;
    ...
    invoke-direct {v0, p0}, LX/22K;-><init>(Lcom/whatsapp/gallerypicker/ImagePreviewFragment;)V

    invoke-virtual {v1, v0}, Lcom/whatsapp/gallerypicker/OnZoomListenerPhotoView;->setOnZoomListener(LX/1L9;)V

    new-instance v0, LX/1K5;

    invoke-direct {v0, p0}, LX/1K5;-><init>(Lcom/whatsapp/gallerypicker/ImagePreviewFragment;)V
    ...
    iput-object v1, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A02:Lcom/whatsapp/doodle/ImagePreviewContentLayout;

    new-instance v0, LX/22Y;

    invoke-direct {v0, p0}, LX/22Y;-><init>(Lcom/whatsapp/gallerypicker/ImagePreviewFragment;)V

    invoke-virtual {v1, v0}, Lcom/whatsapp/doodle/ImagePreviewContentLayout;->setImagePreviewContentLayoutListener(LX/1GY;)V

    new-instance v0, LX/1K6;

    invoke-direct {v0, p0}, LX/1K6;-><init>(Lcom/whatsapp/gallerypicker/ImagePreviewFragment;)V
    ...
    :cond_1
    invoke-virtual {p0, p2}, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A1G(Landroid/os/Bundle;)V
...
.method public A0r(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A07:LX/1A7;
...
.method public A0v(IILandroid/content/Intent;)V
    ...
    invoke-super {p0, p1, p2, p3}, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A0v(IILandroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A00:LX/0sL;

    iget-object v0, p0, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A0E:Landroid/net/Uri;

    invoke-static {v1, v0}, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A00(LX/0sL;Landroid/net/Uri;)Ljava/io/File;
    ...
    iget-object v1, p0, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A0E:Landroid/net/Uri;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A1F()I
    ...
    :cond_2
    :try_start_0
    iget-object v5, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A03:LX/2la;
    ...
    invoke-virtual {v0, v1}, Lcom/whatsapp/PhotoView;->A09(Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A03:LX/2la;
    ...
    iget-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A06:LX/19a;
    ...
    iget v0, v1, Lcom/whatsapp/doodle/DoodleView;->A0S:I

    add-int/2addr v0, v10

    rem-int/lit16 v0, v0, 0x168

    iput v0, v1, Lcom/whatsapp/doodle/DoodleView;->A0S:I

    invoke-virtual {v1}, Lcom/whatsapp/doodle/DoodleView;->A06()V

    invoke-virtual {v1}, Landroid/view/View;->requestLayout()V

    const/4 v0, 0x0

    iput-boolean v0, v1, Lcom/whatsapp/doodle/DoodleView;->A0G:Z
    ...
    :goto_2
    iget-object v1, p0, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A03:LX/0sk;
    ...
    iget-object v2, p0, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A03:LX/0sk;
    ...
    iget-object v0, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A07:LX/1A7;

    invoke-static {v2, p3, v1, v0}, Lcom/whatsapp/crop/CropImage;->A00(LX/0sk;Landroid/content/Intent;LX/0rd;LX/1A7;)V

    goto :goto_3

    :cond_a
    invoke-virtual {p0, v2}, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A1G(Landroid/os/Bundle;)V
    ...
    :cond_b
    :goto_3
    iput-boolean v3, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A01:Z
...
.method public A0z(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A01:Z
...
.method public A12()LX/232;
    ...
    invoke-direct {v0, p0}, LX/2Ff;-><init>(Lcom/whatsapp/gallerypicker/ImagePreviewFragment;)V
...
.method public A13()LX/233;
    ...
    invoke-direct {v0, p0}, LX/2Fg;-><init>(Lcom/whatsapp/gallerypicker/ImagePreviewFragment;)V
...
.method public A15()V
    ...
    iget-object v1, p0, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A02:LX/1K0;
...
.method public A16()V
    ...
    iget-object v2, p0, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A02:LX/1K0;
...
.method public A17()V
    ...
    invoke-virtual {p0}, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A1H()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A00:LX/1GT;
...
.method public A1A()V
    ...
    :cond_0
    invoke-super {p0}, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A1A()V
...
.method public A1E(FF)Z
    ...
    iget-object v1, p0, Lcom/whatsapp/gallerypicker/ImagePreviewFragment;->A02:Lcom/whatsapp/doodle/ImagePreviewContentLayout;

    iget-object v0, v1, Lcom/whatsapp/doodle/ImagePreviewContentLayout;->A02:LX/0xH;
    ...
    :cond_4
    iget-object v2, v1, Lcom/whatsapp/doodle/ImagePreviewContentLayout;->A06:LX/101;
...
.method public final A1G(Landroid/os/Bundle;)V
    ...
    invoke-direct {v2, p0, v0}, LX/22W;-><init>(Lcom/whatsapp/gallerypicker/ImagePreviewFragment;Landroid/net/Uri;)V

    new-instance v1, LX/22X;

    invoke-direct {v1, p0, p1, v3}, LX/22X;-><init>(Lcom/whatsapp/gallerypicker/ImagePreviewFragment;Landroid/os/Bundle;LX/1Ky;)V
