...
.method public synthetic constructor <init>(Lcom/whatsapp/registration/ChangeNumber;)V
    ...
    iput-object p1, p0, LX/36e;->A00:Lcom/whatsapp/registration/ChangeNumber;
...
.method public final ADM(Ljava/lang/String;Ljava/lang/String;[B)V
    ...
    iget-object v3, p0, LX/36e;->A00:Lcom/whatsapp/registration/ChangeNumber;

    iget-object v0, v3, Lcom/whatsapp/registration/ChangeNumber;->A0K:LX/1Qg;

    invoke-virtual {v0}, LX/1Qg;->A05()V

    iget-object v0, v3, Lcom/whatsapp/registration/ChangeNumber;->A09:LX/1Qa;

    invoke-virtual {v0}, LX/1Qa;->A04()V

    iget-object v0, v3, Lcom/whatsapp/registration/ChangeNumber;->A08:LX/0tq;

    const/4 v4, 0x0

    invoke-virtual {v0, v4}, LX/0tq;->A04(Lcom/whatsapp/Me;)V
    ...
    iget-object v2, v3, Lcom/whatsapp/registration/ChangeNumber;->A0I:LX/1T3;
    ...
    iget-object v1, v3, Lcom/whatsapp/registration/ChangeNumber;->A0I:LX/1T3;
    ...
    iput-wide v4, v3, Lcom/whatsapp/registration/ChangeNumber;->A0L:J
    ...
    iput-wide v0, v3, Lcom/whatsapp/registration/ChangeNumber;->A0O:J

    iget-object v1, v3, Lcom/whatsapp/registration/ChangeNumber;->A0Q:LX/19h;
    ...
    invoke-virtual {v3, v0}, Lcom/whatsapp/registration/ChangeNumber;->A0m(Z)V
    ...
    invoke-direct {v0, v3}, LX/36f;-><init>(Lcom/whatsapp/registration/ChangeNumber;)V

    invoke-virtual {v2, v0}, LX/0RT;->A00(LX/0RR;)LX/0RT;

    new-instance v1, LX/36d;

    invoke-direct {v1, v3}, LX/36d;-><init>(Lcom/whatsapp/registration/ChangeNumber;)V
    ...
    :cond_1
    invoke-virtual {v3}, Lcom/whatsapp/registration/ChangeNumber;->A0j()V
