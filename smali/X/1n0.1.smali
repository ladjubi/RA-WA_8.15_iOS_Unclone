...
.method public A00(LX/255;)V
    ...
    iget-object v0, p0, LX/1n0;->A00:Lcom/whatsapp/Conversation;
    ...
    invoke-static {v0}, Lcom/whatsapp/Conversation;->A02(Lcom/whatsapp/Conversation;)I

    invoke-virtual {v0}, Lcom/whatsapp/Conversation;->A10()V
...
.method public A04(LX/255;)V
    ...
    invoke-virtual {v0}, Lcom/whatsapp/Conversation;->A13()V
...
.method public A06(LX/1SB;I)V
    ...
    iget-object v4, p0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget-boolean v0, v4, Lcom/whatsapp/Conversation;->A1t:Z
    ...
    :cond_0
    iget-object v0, v4, Lcom/whatsapp/Conversation;->A0m:LX/1vu;

    invoke-virtual {v0}, LX/1vu;->A02()V

    iget-object v0, p0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    invoke-virtual {v0}, Lcom/whatsapp/Conversation;->A11()V

    :cond_1
    iget-object v1, p0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget v0, v1, Lcom/whatsapp/Conversation;->A3m:I

    if-eqz v0, :cond_2

    iget-object v0, v1, Lcom/whatsapp/Conversation;->A28:LX/0tq;
    ...
    iget v0, v4, Lcom/whatsapp/Conversation;->A3m:I
    ...
    iget v0, v4, Lcom/whatsapp/Conversation;->A3k:I

    invoke-virtual {v5, v0}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v0, v4, Lcom/whatsapp/Conversation;->A3l:I
    ...
    iget-object v0, v0, Lcom/whatsapp/Conversation;->A0A:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lcom/whatsapp/Conversation;->A2l:Landroid/view/ViewGroup;

    invoke-virtual {v0, v2}, Landroid/view/ViewGroup;->setVisibility(I)V

    iget-object v1, p0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget-object v0, v1, Lcom/whatsapp/Conversation;->A2j:LX/1SB;
    ...
    invoke-virtual {v1, v0}, Lcom/whatsapp/Conversation;->A1D(I)V

    iget-object v0, p0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iput-object v2, v0, Lcom/whatsapp/Conversation;->A2j:LX/1SB;
    ...
    iget-object v0, v0, Lcom/whatsapp/Conversation;->A3w:LX/0zT;
    ...
    iget-object v0, v0, Lcom/whatsapp/Conversation;->A3e:LX/19d;
    ...
    iget-object v5, v0, Lcom/whatsapp/Conversation;->A2H:LX/0vF;
...
.method public A07(LX/1SB;I)V
    ...
    iget-object v2, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget-object v2, v2, Lcom/whatsapp/Conversation;->A1v:LX/255;
    ...
    :try_start_0
    iget-object v4, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget-object v4, v4, Lcom/whatsapp/Conversation;->A06:LX/0qI;
    ...
    iget-object v6, v4, Lcom/whatsapp/Conversation;->A1E:Lcom/whatsapp/MentionableEntry;
    ...
    iget-object v4, v6, Lcom/whatsapp/MentionableEntry;->A09:Lcom/whatsapp/MentionPickerView;

    if-eqz v4, :cond_b

    iget-object v4, v4, Lcom/whatsapp/MentionPickerView;->A00:LX/1qM;
    ...
    iget-object v4, v4, Lcom/whatsapp/Conversation;->A0T:LX/1CP;
    ...
    iget v5, v4, Lcom/whatsapp/Conversation;->A3m:I
    ...
    :cond_2
    iget-object v5, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget v4, v5, Lcom/whatsapp/Conversation;->A3m:I

    if-eqz v4, :cond_4

    iget-object v4, v5, Lcom/whatsapp/Conversation;->A06:LX/0qI;
    ...
    iget-object v5, v4, Lcom/whatsapp/Conversation;->A06:LX/0qI;
    ...
    iget-object v4, v4, Lcom/whatsapp/Conversation;->A28:LX/0tq;
    ...
    invoke-virtual {v4}, Lcom/whatsapp/Conversation;->A13()V
    ...
    iget-object v6, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget v4, v6, Lcom/whatsapp/Conversation;->A3m:I

    add-int/2addr v4, v2

    iput v4, v6, Lcom/whatsapp/Conversation;->A3m:I
    ...
    iget v4, v6, Lcom/whatsapp/Conversation;->A3l:I

    add-int/2addr v4, v2

    iput v4, v6, Lcom/whatsapp/Conversation;->A3l:I
    ...
    iget v4, v5, Lcom/whatsapp/Conversation;->A3k:I

    invoke-virtual {v6, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v6, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v4, v5, Lcom/whatsapp/Conversation;->A3l:I
    ...
    iget-object v4, v4, Lcom/whatsapp/Conversation;->A0A:Ljava/util/ArrayList;
    ...
    :cond_7
    iget v4, v6, Lcom/whatsapp/Conversation;->A3k:I

    add-int/2addr v4, v2

    iput v4, v6, Lcom/whatsapp/Conversation;->A3k:I
    ...
    invoke-virtual {v4}, Lcom/whatsapp/Conversation;->A1B()V
    ...
    iget-object v4, v4, Lcom/whatsapp/Conversation;->A30:Landroid/view/View;
    ...
    iget v4, v5, Lcom/whatsapp/Conversation;->A3j:I

    add-int/2addr v4, v2

    iput v4, v5, Lcom/whatsapp/Conversation;->A3j:I

    iget-object v4, v5, Lcom/whatsapp/Conversation;->A3i:Landroid/widget/TextView;

    invoke-virtual {v4, v3}, Landroid/widget/TextView;->setVisibility(I)V

    iget-object v4, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget-object v7, v4, Lcom/whatsapp/Conversation;->A3i:Landroid/widget/TextView;
    ...
    iget v4, v4, Lcom/whatsapp/Conversation;->A3j:I
    ...
    invoke-static {v5}, Lcom/whatsapp/Conversation;->A03(Lcom/whatsapp/Conversation;)V
    ...
    iget-object v4, v4, Lcom/whatsapp/Conversation;->A3i:Landroid/widget/TextView;
    ...
    iget-object v4, v4, Lcom/whatsapp/Conversation;->A1l:Ljava/util/ArrayList;

    invoke-virtual {v4, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v4, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget-object v9, v4, Lcom/whatsapp/Conversation;->A1k:Landroid/widget/TextView;
    ...
    iget-object v4, v4, Lcom/whatsapp/Conversation;->A32:Landroid/view/View;
    ...
    iget-object v6, v4, Lcom/whatsapp/Conversation;->A1h:LX/17x;
    ...
    iget-object v3, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    invoke-virtual {v3}, Lcom/whatsapp/Conversation;->A19()V

    :cond_f
    iget-object v3, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget-object v3, v3, Lcom/whatsapp/Conversation;->A28:LX/0tq;
    ...
    invoke-virtual {v3}, Lcom/whatsapp/Conversation;->A1A()V

    :cond_10
    iget-object v4, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget-boolean v3, v4, Lcom/whatsapp/Conversation;->A1t:Z

    if-eqz v3, :cond_12

    iget-object v3, v4, Lcom/whatsapp/Conversation;->A2f:LX/2Uy;
    ...
    iget-object v4, v5, Lcom/whatsapp/Conversation;->A22:Landroid/widget/ListView;

    new-instance v3, LX/0bS;

    invoke-direct {v3, v5}, LX/0bS;-><init>(Lcom/whatsapp/Conversation;)V
    ...
    iget-object v0, v0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iput-boolean v2, v0, Lcom/whatsapp/Conversation;->A1H:Z
    ...
    invoke-static {v4}, Lcom/whatsapp/Conversation;->A03(Lcom/whatsapp/Conversation;)V
...
.method public A08(LX/1SB;I)V
    ...
    iget-object v2, p0, LX/1n0;->A00:Lcom/whatsapp/Conversation;

    iget-object v1, v2, Lcom/whatsapp/Conversation;->A22:Landroid/widget/ListView;

    new-instance v0, LX/0ba;

    invoke-direct {v0, v2, p1, p2}, LX/0ba;-><init>(Lcom/whatsapp/Conversation;LX/1SB;I)V
    ...
    iget-object v0, v0, Lcom/whatsapp/Conversation;->A12:Landroid/util/SparseArray;
...
.method public A0A(Ljava/util/Collection;LX/255;Ljava/util/Map;Z)V
    ...
    iget-object v1, v0, Lcom/whatsapp/Conversation;->A2u:Ljava/util/HashSet;
...
.method public A0B(Ljava/util/Collection;Ljava/util/Map;)V
    ...
    iget-object v2, v0, Lcom/whatsapp/Conversation;->A1p:LX/2nR;
    ...
    iget-object v0, v1, Lcom/whatsapp/Conversation;->A06:LX/0qI;
    ...
    iget-object v0, v0, Lcom/whatsapp/Conversation;->A1p:LX/2nR;
