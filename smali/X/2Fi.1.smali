...
# direct methods
.method public constructor <init>(Lcom/whatsapp/gallerypicker/MediaPreviewActivity;LX/07z;)V
    .locals 0

    iput-object p1, p0, LX/2Fi;->A00:Lcom/whatsapp/gallerypicker/MediaPreviewActivity;
...
.method public A01()I
    ...
    iget-object v0, p0, LX/2Fi;->A00:Lcom/whatsapp/gallerypicker/MediaPreviewActivity;
...
.method public A02(Ljava/lang/Object;)I
    ...
    iget-object v1, p1, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A0E:Landroid/net/Uri;
...
.method public A0A(Landroid/view/ViewGroup;)V
    ...
    :cond_0
    iget-object v1, p0, LX/2Fi;->A00:Lcom/whatsapp/gallerypicker/MediaPreviewActivity;

    iget v0, v1, Lcom/whatsapp/gallerypicker/MediaPreviewActivity;->A0b:I

    if-gez v0, :cond_1

    iget-object v0, v1, Lcom/whatsapp/gallerypicker/MediaPreviewActivity;->A0r:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v0}, Lcom/whatsapp/gallerypicker/MediaPreviewActivity;->A0q(I)V
    ...
    iget-object v0, v0, Lcom/whatsapp/gallerypicker/MediaPreviewActivity;->A0w:Landroid/graphics/Rect;

    invoke-virtual {v1, v0}, Lcom/whatsapp/gallerypicker/MediaPreviewFragment;->A1B(Landroid/graphics/Rect;)V
...
.method public A0C(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget-object v0, v0, Lcom/whatsapp/gallerypicker/MediaPreviewActivity;->A0f:LX/0xH;
...
.method public A0F(I)J
    ...
    iget-object v2, v0, Lcom/whatsapp/gallerypicker/MediaPreviewActivity;->A0U:Ljava/util/HashMap;

    iget-object v1, v0, Lcom/whatsapp/gallerypicker/MediaPreviewActivity;->A0r:Ljava/util/ArrayList;
...
.method public A0G(I)LX/28a;
    ...
    iget-object v0, v1, Lcom/whatsapp/gallerypicker/MediaPreviewActivity;->A0O:LX/1L2;

    invoke-virtual {v0, v3}, LX/1L2;->A01(Landroid/net/Uri;)LX/1Kz;

    move-result-object v0

    invoke-static {v1, v0}, Lcom/whatsapp/gallerypicker/MediaPreviewActivity;->A00(Lcom/whatsapp/gallerypicker/MediaPreviewActivity;LX/1Kz;)B
