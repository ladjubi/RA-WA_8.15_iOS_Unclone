...
.method public constructor <init>(Lcom/whatsapp/StatusesFragment;)V
    ...
    iget-object v0, p1, Lcom/whatsapp/StatusesFragment;->A0Z:Ljava/util/Set;
...
.method public onPostExecute(Ljava/lang/Object;)V
    ...
    check-cast v5, Lcom/whatsapp/StatusesFragment;

    if-eqz v5, :cond_f

    const/4 v0, 0x0

    iput-object v0, v5, Lcom/whatsapp/StatusesFragment;->A0Y:LX/0y4;

    iput-object p1, v5, Lcom/whatsapp/StatusesFragment;->A0q:LX/0y5;

    const/4 v0, -0x1

    iput v0, v5, Lcom/whatsapp/StatusesFragment;->A0E:I

    iput v0, v5, Lcom/whatsapp/StatusesFragment;->A0J:I
    ...
    iput-boolean v0, v5, Lcom/whatsapp/StatusesFragment;->A0G:Z

    :cond_0
    iget-object v0, v5, Lcom/whatsapp/StatusesFragment;->A0r:LX/0y6;

    invoke-virtual {v0}, LX/0y6;->getFilter()Landroid/widget/Filter;

    move-result-object v1

    iget-object v0, v5, Lcom/whatsapp/StatusesFragment;->A0D:Ljava/lang/CharSequence;

    invoke-virtual {v1, v0}, Landroid/widget/Filter;->filter(Ljava/lang/CharSequence;)V

    iget-object v0, v5, Lcom/whatsapp/StatusesFragment;->A0q:LX/0y5;
    ...
    iput-wide v2, v7, Lcom/whatsapp/HomeActivity;->A0X:J

    :cond_3
    iget-object v6, v7, LX/2M4;->A0D:LX/0sk;

    iget-object v9, v7, Lcom/whatsapp/HomeActivity;->A0D:Ljava/lang/Runnable;
    ...
    iget v9, v7, Lcom/whatsapp/HomeActivity;->A0x:I

    const/4 v6, 0x2

    if-ne v9, v6, :cond_a

    invoke-virtual {v7}, Lcom/whatsapp/HomeActivity;->A0l()V

    :cond_4
    :goto_1
    iget-object v2, v5, Lcom/whatsapp/StatusesFragment;->A0s:LX/0yE;
    ...
    :cond_8
    invoke-virtual {v5}, Lcom/whatsapp/StatusesFragment;->A16()V

    invoke-virtual {v5}, Lcom/whatsapp/StatusesFragment;->A1A()V

    invoke-virtual {v5}, Lcom/whatsapp/StatusesFragment;->A1C()V

    invoke-virtual {v5}, Lcom/whatsapp/StatusesFragment;->A17()V
    ...
    iget-object v1, v5, Lcom/whatsapp/StatusesFragment;->A02:LX/0pA;
    ...
    iget-object v6, v7, Lcom/whatsapp/HomeActivity;->A16:LX/2Df;
    ...
    invoke-virtual {v7}, Lcom/whatsapp/HomeActivity;->A0p()V
    ...
    :cond_e
    iget-object v3, v5, Lcom/whatsapp/StatusesFragment;->A0d:LX/10w;
