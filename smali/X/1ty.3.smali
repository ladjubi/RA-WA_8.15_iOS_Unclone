...
.method public AJR(Landroid/view/View;Landroid/graphics/Bitmap;LX/1SB;)V
    ...
    iget-object v0, v4, Lcom/whatsapp/Conversation;->A0P:LX/12e;

    if-nez v0, :cond_0

    new-instance v1, LX/12e;

    iget-object v0, v4, Lcom/whatsapp/Conversation;->A0O:LX/12c;

    invoke-direct {v1, v0}, LX/12e;-><init>(LX/12c;)V

    iput-object v1, v4, Lcom/whatsapp/Conversation;->A0P:LX/12e;

    :cond_0
    iget-object v9, v4, Lcom/whatsapp/Conversation;->A0P:LX/12e;
    ...
    invoke-static/range {v10 .. v15}, Lcom/whatsapp/biz/catalog/CatalogDetailActivity;->A02(LX/2G9;LX/1EK;Landroid/view/View;Landroid/content/Context;ZLX/2k1;)V
